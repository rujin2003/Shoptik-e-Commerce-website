                    ...
                    <div className="relative mt-10 md:mt-24">
                        ...
                        <div className="relative grid max-w-lg grid-cols-1 gap-6 mx-auto md:max-w-none lg:gap-10 md:grid-cols-3">
                            ...
                            <TestimonialCard 
                                ...
                                imgSrc="https://cdn.rareblocks.xyz/collection/clarity/images/testimonial/4/avatar-female-1.png"
                                quote="“This is an amazing tool. It has significantly improved my productivity and workflow.”"
                            />
                        </div>
                    </div>
                </div>
...
const TestimonialCard = ({ name, role, imgSrc, quote }) => (
    <div className="flex flex-col overflow-hidden shadow-xl">
        <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
            ...
            <div className="flex items-center mt-8">
                <img className="flex-shrink-0 object-cover rounded-full w-11 h-11" src={imgSrc} alt={name} />
                <div className="ml-4">
